...
const AboutUs = () => {
  ...
  return (
    <section className="container z-50">
        ...
        <div>
          ...
          <div className="md:w-[637px] md:text-[26px] text-xl text-[#5D5D5D] md:leading-[41.6px] md:mt-6 mt-4">
            <p>
              ...
              design-driven solutions that help startups and businesses thrive.
              Our team works closely with clients to bring their ideas to
              life...
              {!isExpanded && (
                <span
            ...
            {isExpanded && (
              <div>
                <p>
                  ...
                  and design-driven solutions that help startups and businesses
                  thrive. Our team works closely with clients to bring their
                  ideas to life...
                  <span
