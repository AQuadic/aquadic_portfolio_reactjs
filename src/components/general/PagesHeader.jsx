...
const PagesHeader = ({ fheader, sheader, title }) => {
    return (
        <section className="container flex flex-col items-center justify-center text-center pt-10">
            <h1 className="text-brandColor md:text-5xl text-3xl font-semibold md:leading-[48px] flex rtl:gap-2 rtl:flex-row-reverse"> {fheader} <span className="text-[#121212]"> &nbsp;{sheader} </span></h1>
